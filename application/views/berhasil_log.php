			...
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178">
                 ...
                 Authentication Score
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Your Authentication Score">
						<input class="input100" type="text" name="otp" placeholder="Please enter your OTP code" value="<?php echo $this->session->userdata('nilai'); ?>">
